        ...
        try:
            ...
            logger.info(
                ...
                extra={
                    "transaction_id": transaction_id,
                    "file_name": file_name,
                    "all_complete_from_check_method": all_complete,
                    "completed_documents_counter": completed_docs,
                    "total_documents_counter": total_docs,
                    "gate_condition_1_all_complete": all_complete,
                    "gate_condition_2_counters_match": completed_docs >= total_docs,
                    "will_send_email": all_complete and completed_docs >= total_docs,
            ...
            if not all_complete or completed_docs < total_docs:
                logger.info(
                    ...
                    extra={
                        ...
                        "reason": f"all_complete={all_complete}, completed_docs({completed_docs}) < total_docs({total_docs})"
                    }
                )
                return {
                    "status": "success",
